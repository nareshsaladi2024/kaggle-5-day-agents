...
# This file makes all agents in Day1b discoverable by ADK web server
...
try:
    from Day1b.AggregatorAgent.agent import root_agent
    # root_agent is now available for ADK discovery
except ImportError as e:
    print(f"Warning: Could not import agent from Day1b.AggregatorAgent.agent : {e}")
    ...
    root_agent = Agent(
        ...
        description="Wrapper agent for Day1b - import failed",
