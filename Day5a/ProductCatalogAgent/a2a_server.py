"""
A2A Server for ProductCatalogAgent

This module exposes the ProductCatalogAgent via the A2A (Agent-to-Agent) protocol,
...
# Port configuration
A2A_PORT = int(os.environ.get("PRODUCTCATALOGAGENT_A2A_PORT", "10104"))

# Create the A2A application
print(f"🚀 Starting ProductCatalogAgent A2A Server on port {A2A_PORT}")
