"""
A2A Server for CustomerSupportAgent

This module exposes the CustomerSupportAgent via the A2A (Agent-to-Agent) protocol,
...
# Port configuration
A2A_PORT = int(os.environ.get("CUSTOMERSUPPORTAGENT_A2A_PORT", "10103"))

# Create the A2A application
print(f"🚀 Starting CustomerSupportAgent A2A Server on port {A2A_PORT}")
