...
# ============================================================================
# Helper Functions for Long-Running Operations Workflow
# ============================================================================
...
def create_approval_response(approval_info, approved):
    ...
    Args:
        ...
        approved: Boolean indicating if the order is approved
        
    Returns:
        Content object with FunctionResponse for ADK
    """
...
async def run_shipping_workflow(query: str, auto_approve: bool = True):
    ...
    2. Detects if approval is needed (checks for adk_request_confirmation event)
    3. If approval needed: pauses, gets human decision, resumes with same invocation_id
    4. If no approval needed: completes immediately

    Args:
        query: User's shipping request (e.g., "Ship 10 containers to Rotterdam")
...
# For ADK web, we expose the agent directly (not the app)
root_agent = shipping_agent

# Ensure logging is maintained after agent creation
ensure_debug_logging(agent_name="shipping_agent")