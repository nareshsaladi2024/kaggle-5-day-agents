...
# This file makes all agents in Day2b discoverable by ADK web server
...
try:
    from Day2b.image_agent.agent import root_agent
    # root_agent is now available for ADK discovery
except ImportError as e:
    print(f"Warning: Could not import agent from Day2b.image_agent.agent : {e}")
    ...
    root_agent = Agent(
        ...
        description="Wrapper agent for Day2b - import failed",
