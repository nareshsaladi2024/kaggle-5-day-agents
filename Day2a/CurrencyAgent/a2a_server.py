"""
A2A Server for CurrencyAgent

This module exposes the CurrencyAgent via the A2A (Agent-to-Agent) protocol,
...
# Port configuration
A2A_PORT = int(os.environ.get("CURRENCYAGENT_A2A_PORT", "10102"))

# Create the A2A application
print(f"🚀 Starting CurrencyAgent A2A Server on port {A2A_PORT}")
